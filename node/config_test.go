...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "aft.ipc", false, filepath.Join(os.TempDir(), "aft.ipc")},
		{"data", "aft.ipc", false, "data/aft.ipc"},
		{"data", "./aft.ipc", false, "./aft.ipc"},
		{"data", "/aft.ipc", false, "/aft.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "aft.ipc", true, `\\.\pipe\aft.ipc`},
		{"data", "aft.ipc", true, `\\.\pipe\aft.ipc`},
		{"data", `\\.\pipe\aft.ipc`, true, `\\.\pipe\aft.ipc`},
	}
