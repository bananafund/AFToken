...
//
// Detailed usage document and tutorial available on the go-aft Wiki page:
// https://github.com/bananafund/AFToken/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
