...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/aft.ipc",
			endpoint:    "/data/testnet/aft.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/aft.ipc",
			endpoint:    "/data/testnet/aft.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aft.ipc",
			endpoint:    "/data/testnet/aft.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aft.ipc",
			endpoint:    "/data/testnet/aft.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
