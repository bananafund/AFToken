...
import (
	...
	aftmetrics "github.com/bananafund/AFToken/metrics"
	"github.com/bananafund/AFToken/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if aftmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(aftmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
