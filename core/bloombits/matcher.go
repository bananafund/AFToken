...
// that address/topic, and binary AND-ing those vectors toafter.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toafter
				var orVector []byte
...
// the reuested retrieval queue to be serviced toafter with other sessions.
//
