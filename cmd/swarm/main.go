...
import (
	...
	"github.com/bananafund/AFToken/ethclient"
	"github.com/bananafund/AFToken/internal/debug"
	...
	"github.com/bananafund/AFToken/swarm"
	bzzapi "github.com/bananafund/AFToken/swarm/api"
	swarmmetrics "github.com/bananafund/AFToken/swarm/metrics"
...
// This init function sets defaults so cmd/swarm can run alongside aft.
func init() {
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The go-aft Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//aft only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for aft and swarm
